...
public class URLs implements UrlFragments {
    ...
    public URLs(String protocol, String hostFragments, String pathFragments, String queryParamValues, UrlConfig config) {
